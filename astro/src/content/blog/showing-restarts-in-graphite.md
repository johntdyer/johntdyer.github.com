...
description: "Currently we use CollectD’s [uptime][collectd-uptime] plugin to track system uptime. We then use [Curl-Json][collectd-curl-json] along with [Jolokia][jolokia] t"
pubDate: 'Sep 26, 2013'
tags: ['general']
---
...
![Results](https://johntdyer.com/assets/media/memory.png)
